...
import { authInterceptor, refreshTokenInterceptor } from './app/auth.interceptor';
...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    provideHttpClient(
      withInterceptors([authInterceptor, refreshTokenInterceptor])  // Registrando o interceptor
    ),
